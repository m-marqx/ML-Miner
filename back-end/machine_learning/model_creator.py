...
class ModelCreator:
    ...
    def generate_hyperparameters(self) -> dict:
        ...
        """
        hyperparameter_seed = np.random.choice(range(1, 50_000, 1))
        ...
        return {
            ...
            "depth": self.hyperparameter_rng.choice(range(1, 5, 1)),
            ...
            "reg_lambda": self.hyperparameter_rng.choice(range(1, 103, 1)),
            "use_best_model": True,
